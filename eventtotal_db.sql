...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-09-2024 a las 01:01:46
...
--
-- Volcado de datos para la tabla `insumos_eventtotal`
--

INSERT INTO `insumos_eventtotal` (`id_is`, `nombre_is`, `categoria_is`, `unidad_medida_is`, `cantidad_is`, `precio_unitario_is`, `descripcion_is`, `id_u`) VALUES
(2, 'Arroz Prueba', 'Legumbre', 7, 5, 5, 'Arroz de la mejor calidad 100%', 2),
(16, 'Chile', 'Verdura', 3, 5, 50, 'Pica Mucho', 5);
...
--
-- Volcado de datos para la tabla `inventario_eventtotal`
--

INSERT INTO `inventario_eventtotal` (`codigo_barras`, `producto_i`, `categoria_i`, `cantidad_i`, `imagen_i`, `id_u`) VALUES
(1, 'Tele', 'Electrónicos', 1, '', 2);
...
(9, 'Pollo a la crema', '                                                                        ffff                                                                    ', '                                                                        ffff                                                                    ', '10 horas', 13, 'baja', '                                                                        sdvdfvdfs                                                                    ', 'estofado'),
(10, 'Pollo a la gordon blue', '                                                                                                                                                                                                                        f                                           ', 'GG', '1 horas', 6, 'Dificil', 'GG                  ', 'Postre');
...
(2, 'La casa blanca', 200, 'function', 'none', 1);
...
(1, 'Hiojan Geovanny', 'Carrasco Garci', '2002-09-05', 'hiojan75@gmail.com', '3312', 'admin', '', 0, 'none'),
(2, 'Jonathan Aldair', 'Leon Trejo', '2002-10-11', 'jonathanleont11@gmail.com', 'jonathan11', 'admin', '', 0, 'none'),
(5, 'Ramiro', 'Sanchez', '2023-07-21', 'ramiro@gmail.com', '12345', 'admin', '', 0, 'blocked');
...
--
ALTER TABLE `insumos_eventtotal`
  MODIFY `id_is` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `inventario_eventtotal`
--
ALTER TABLE `inventario_eventtotal`
  MODIFY `codigo_barras` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
