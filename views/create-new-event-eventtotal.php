...
<head>
    ...
    <title>EventTotal | Nuevo Evento</title>
    <!-- link de favicon -->
    ...
    <link rel="stylesheet" href="../assets/css/style-create-new-event-eventtotal.css">
...
<body>
    ...
    <div class="wrapper" id="contenedor-main">
        <h1>Agendar nuevo evento</h1>
        <div class="container-form-event">
            <h5>Datos del cliente: </h5>

            <!-- HAY QUE AGREGAR EL ACTION DONDE SE HAGA LA INSERCION DE LOS DATOS A LA BASE DE DATOS !!!!!!!!!!!!!!!!!!!!!!!! -->
            <form action="../Create-Event/" method="POST">
                ...
                <div class="section-user-information">
                        ...
                        <div class="dates-user">
                            <div class="mb-3">
                                <label for="name_client-c" class="form-label">Nombre del cliente:</label>
                                <input type="text" name="name-client-c" id="name_client-c" class="form-control" value="<?php echo $name_client ?>">
                            </div>


                            <div class="mb-3">
                                <label for="tematic_party-c" class="form-label">Tipo de evento:</label>
                                <input type="text" name="tematic-party-c" id="tematic_party-c" class="form-control" value="<?php echo $tipe_event ?>">
                            </div>
                        </div>

                        <div class="dates-user">
                            <div class="mb-3">
                                <label for="num_invitades-c" class="form-label">Numero de invitados:</label>
                                <input type="number" name="num-invitades-c" id="num_invitades-c" class="form-control" value="<?php echo $num_guests ?>">
                            </div>

                            <div class="mb-3">
                                <label for="date-event-c" class="form-label">Fecha y hora del evento:</label>
                                <input type="datetime-local" name="date-event-c" id="date-event-c" class="form-control" value="<?php echo $date_event ?>">
                            </div>
                        </div>
                </div>


                <h5>Datos para agendar el evento: </h5>

                <div class="section-user-information">
                    <div class="dates-user">
                        <div class="mb-3">
                            <label for="tematic" class="form-label">Tematica:</label>
                            <input name="tematic" id="tematic" class="form-control" placeholder="Agregar una tematica, si no la hay coloca ninguna">
                        </div>

                        <div class="mb-3">
                            <label for="user-ident" class="form-label">Encargado del evento:</label>
                            <select name="user-ident" id="user-ident" class="form-control">
                    ...
                    <div class="dates-user">
                        <div class="mb-3">
                            <label for="salones" class="form-label">Salon de eventos:</label>
                            <select name="salon" id="salones" class="form-control">
                                <?php foreach ($salones as $y) { ?>
                                    <option value="<?php echo $y['id_s'] ?>"><?php echo $y['nombre_s'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="button-create-event">
                    <input type="submit" value="Agendar el nuevo evento" class="btn" style="background-color: #718ae9; color: white;">
                </div>
